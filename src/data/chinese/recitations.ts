...
export const chineseRecitations: RecitationItem[] = [
  ...
  },
  {
    ...
    type: 'poetry',
    content: '空山不见人，但闻人语响。\n返景入深林，复照青苔上。',
    keySentences: ['空山不见人', '返景入深林', '复照青苔上'],
    translation: '空山里看不到人影，只听到人说话的声音。夕阳余光返照入深林，又照在青苔上。',
    background: '王维山水诗名篇，以动衬静，描绘出空山深林的幽静画面。',
    difficulty: 2,
    stars: 0,
  },
  {
    ...
    keySentences: ['嫦娥应悔偷灵药', '碧海青天夜夜心'],
    translation: '嫦娥应该后悔偷吃了灵药，每夜面对碧海青天独自伤心。',
    background: '李商隐借嫦娥的孤独，表达一种清冷孤寂的心境。',
    difficulty: 3,
    stars: 0,
  },
  {
