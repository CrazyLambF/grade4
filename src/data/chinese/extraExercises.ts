...
export const chineseExtraExercises: Question[] = [
  ...
  { id: 'cn-1-2-2', subject: 'chinese', unit: 1, lesson: 2, type: 'fill', difficulty: 1, content: '《繁星》作者巴金，三次看星空分别在从前、______和如今。', answer: '三年前', analysis: '从前庭院、三年前南京、如今海上。', knowledgePoints: ['课文内容'] },
  { id: 'cn-1-2-3', subject: 'chinese', unit: 1, lesson: 2, type: 'choice', difficulty: 2, content: '《繁星》的写作顺序是？', options: ['空间顺序', '时间顺序', '逻辑顺序', '事情发展顺序'], answer: '时间顺序', analysis: '从前、三年前、如今，按时间顺序。', knowledgePoints: ['文章结构'] },
  ...
  { id: 'cn-2-3-2', subject: 'chinese', unit: 2, lesson: 3, type: 'choice', difficulty: 2, content: '《方帽子店》告诉我们什么道理？', options: ['帽子要方的好', '要敢于创新', '方帽子便宜', '不要买帽子'], answer: '要敢于创新', analysis: '方帽子代表守旧，圆帽子代表创新，要敢于创新。', knowledgePoints: ['文章主旨'] },
  { id: 'cn-2-4-2', subject: 'chinese', unit: 2, lesson: 4, type: 'choice', difficulty: 2, content: '《田忌赛马》中出谋划策的是谁？', options: ['田忌', '孙膑', '齐王', '将军'], answer: '孙膑', analysis: '孙膑观察后提出调整出场顺序的策略。', knowledgePoints: ['课文内容'] },
  ...
  // === 第六单元（新版：长城、颐和园、秦兵马俑）===
  { id: 'cn-6-1-2', subject: 'chinese', unit: 6, lesson: 1, type: 'choice', difficulty: 2, content: '《长城》一文赞美了什么？', options: ['长城的美丽', '劳动人民的智慧和毅力', '皇帝的伟大', '山的高大'], answer: '劳动人民的智慧和毅力', analysis: '长城是古代劳动人民智慧和毅力的结晶。', knowledgePoints: ['文章主旨'] },
  { id: 'cn-6-2-2', subject: 'chinese', unit: 6, lesson: 2, type: 'fill', difficulty: 1, content: '颐和园的长廊全长______多米。', answer: '700', analysis: '长廊全长700多米。', knowledgePoints: ['课文内容'] },
  { id: 'cn-6-3-2', subject: 'chinese', unit: 6, lesson: 3, type: 'choice', difficulty: 2, content: '秦兵马俑的特点是？', options: ['数量少', '规模宏大、个性鲜明', '只有一种', '年代很近'], answer: '规模宏大、个性鲜明', analysis: '兵马俑规模宏大，每个神态各异。', knowledgePoints: ['课文内容'] },

  // === 第七单元（新版：牛和鹅、一只窝囊的大老虎、陀螺、王戎不取道旁李）===
  { id: 'cn-7-1-1', subject: 'chinese', unit: 7, lesson: 1, type: 'choice', difficulty: 2, content: '《牛和鹅》告诉我们什么道理？', options: ['牛比鹅好', '角度不同看法不同', '鹅很凶', '要怕鹅'], answer: '角度不同看法不同', analysis: '金奎叔的话启示换角度思考。', knowledgePoints: ['文章主旨'] },
  { id: 'cn-7-3-1', subject: 'chinese', unit: 7, lesson: 3, type: 'fill', difficulty: 1, content: '人不可貌相，______。', answer: '海水不可斗量', analysis: '《陀螺》中心句，俗语。', knowledgePoints: ['课文背诵'] },
  { id: 'cn-7-3-2', subject: 'chinese', unit: 7, lesson: 3, type: 'choice', difficulty: 1, content: '《陀螺》作者是？', options: ['高洪波', '冰心', '老舍', '巴金'], answer: '高洪波', analysis: '高洪波，儿童文学作家。', knowledgePoints: ['文学常识'] },
  { id: 'cn-7-4-2', subject: 'chinese', unit: 7, lesson: 4, type: 'choice', difficulty: 2, content: '《王戎不取道旁李》选自？', options: ['《论语》', '《世说新语》', '《史记》', '《左传》'], answer: '《世说新语》', analysis: '南朝刘义庆编《世说新语》。', knowledgePoints: ['文学常识'] },
  { id: 'cn-7-4-3', subject: 'chinese', unit: 7, lesson: 4, type: 'fill', difficulty: 2, content: '诸儿竞走取之，唯______不动。', answer: '戎', analysis: '只有王戎不动。', knowledgePoints: ['文言文'] },

  // === 第八单元（新版：我将无我不负人民、为中华之崛起而读书、延安我把你追寻、古诗三首）===
  { id: 'cn-8-1-2', subject: 'chinese', unit: 8, lesson: 1, type: 'choice', difficulty: 2, content: '"我将无我，不负人民"表达了什么精神？', options: ['自私自利', '忘我为人民', '不要自己', '不负责任'], answer: '忘我为人民', analysis: '"无我"是忘我的奉献精神。', knowledgePoints: ['课文理解'] },
  { id: 'cn-8-2-2', subject: 'chinese', unit: 8, lesson: 2, type: 'choice', difficulty: 2, content: '周恩来立下志向的原因是？', options: ['考试成绩好', '目睹中国人受欺', '老师要求', '父亲命令'], answer: '目睹中国人受欺', analysis: '在租界看到中国人被欺负而立志。', knowledgePoints: ['课文内容'] },
  { id: 'cn-8-3-1', subject: 'chinese', unit: 8, lesson: 3, type: 'fill', difficulty: 1, content: '延安精神的核心是______和艰苦奋斗。', answer: '自力更生', analysis: '延安精神：自力更生、艰苦奋斗。', knowledgePoints: ['课文内容'] },
  { id: 'cn-8-4-4', subject: 'chinese', unit: 8, lesson: 4, type: 'fill', difficulty: 1, content: '葡萄美酒夜光杯，______。', answer: '欲饮琵琶马上催', analysis: '王翰《凉州词》。', knowledgePoints: ['古诗默写'] },
  { id: 'cn-8-4-5', subject: 'chinese', unit: 8, lesson: 4, type: 'choice', difficulty: 2, content: '"但使龙城飞将在"中的"飞将军"指？', options: ['霍去病', '李广', '卫青', '岳飞'], answer: '李广', analysis: '飞将军指汉代名将李广。', knowledgePoints: ['古诗理解'] },
  { id: 'cn-8-4-6', subject: 'chinese', unit: 8, lesson: 4, type: 'choice', difficulty: 2, content: '《出塞》《凉州词》《夏日绝句》的共同主题是？', options: ['思乡', '家国情怀', '田园', '送别'], answer: '家国情怀', analysis: '三首诗都体现爱国情怀。', knowledgePoints: ['诗歌主题'] },
